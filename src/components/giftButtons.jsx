...
export function GiftButtons() {
    ...
    return (
        ...
        <div className="flex flex-col md:flex-row gap-8 sm:gap-12 justify-center items-center py-4 pb-6">
            ...
            <ModalWithImage imgSrc={"https://preview.redd.it/i-made-a-thermomix-drawing-yesterday-v0-7ztzgb8eh2w81.jpg?auto=webp&s=7e813abc716908b69685fc7184da5d6f9130b24b"} textHeader={"Un gadget fenomenale!"} textBody={"Il Bimby!"} nome={"Giada Sponzilli"} iban={"BEXX XXXX XXXX XXXX"} banca={"Wise, Rue du Trône 100, 3rd floor, Brussels, 1050, Belgium!"} />
        </div>
