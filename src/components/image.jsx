...
export function ImgWithBlurredCaption() {
    return (
        <figure className="relative h-96 w-full">
            ...
            <figcaption className="absolute bottom-4 left-2/4 flex w-[calc(100%-25rem)] -translate-x-2/4 justify-center rounded-xl border bg-white/75 py-2 shadow-lg shadow-black/5 backdrop-blur-sm">
                <div>
                    <Countdown />
                </div>
            </figcaption>
